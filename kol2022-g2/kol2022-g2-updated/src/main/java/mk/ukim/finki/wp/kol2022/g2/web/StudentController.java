...
public class StudentController {
    ...
    public String create(@RequestParam String name,
        ...
        this.studentService.create(name, email, password, type, coursesId, LocalDate.parse(enrollmentDate));
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam List<Long> coursesId,
                         @RequestParam String enrollmentDate) {
        this.studentService.update(id, name, email, password, type, coursesId, LocalDate.parse(enrollmentDate));
        return "redirect:/students";
    }
